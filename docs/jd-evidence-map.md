...
|---|---|---|
| Production/application support | Live operations dashboard, health/readiness, status, runbook, drill | Verified locally |
| Deployment quality | Ruff, MyPy, Bandit, 19 tests, 93% coverage, dashboard-aware container smoke | Verified locally and in GitHub CI |
...
| Monitoring/support | Live dashboard, Prometheus metrics, synthetic monitor, structured logs | Verified locally |
